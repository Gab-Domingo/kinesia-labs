...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    const observerOptions = { root: null, rootMargin: '0px', threshold: 0.1 } as const;
  ...
  return (
    <span className={parentClassName} ref={containerRef} style={stylesInline.wrapper} {...hoverProps} {...props}>
      <span style={stylesInline.srOnly}>{displayText}</span>
